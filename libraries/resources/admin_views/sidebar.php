...
<div class="sidenav">
    <div class="sidenav_profile">
        <div class="side_image text-center py-5">
            <span>
            ...
            <h3 class="side_name"><?php echo $_SESSION['fullname']; ?></h3>
            <span class="badge bg-danger"><?php echo $_SESSION['roles']; ?></span>
        </div>
    </div>
    <ul class="navbar-nav my-4">
        <li class="nav-item act">
            <a href="dashboard.php" class="nav-link">
                ...
                <span class="side_link">Dashboard</span>
            </a>
        </li>
        <li class="nav-item">
            <a href="create_user.php" class="nav-link">
                ...
                <span class="side_link">Create User</span>
            </a>
        </li>
        <li class="nav-item">
            <a href="data_table.php" class="nav-link">
                ...
                <span class="side_link">Data Table</span>
            </a>
        </li>
    </ul>
</div>
